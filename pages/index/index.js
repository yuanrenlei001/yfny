...
Page({
  ...
  onLoad(){
    var showDialog = app.data.showDialog;
  ...
  init() {
    ...
    // 加载loding
    wx.request({
      url: app.get_request_urls("index", "index"),
      method: "POST",
      data: {},
      dataType: "json",
      success: res => {
        ...
        console.log(app.get_request_urls("index", "index"))
        console.log(app.get_request_url("index", "index"))
        if (res.data.code == 0) {
